...
const Footer = () => {
    return (
        <>
            <footer className="flex text-gray-600 font-mono justify-center items-center">
                <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                    <Link to="/" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                        <img src="/svg/logo.svg" alt="Logo" className="w-7 mr-1" />
                        <span className="font-bold text-indigo-500 ml-2">STAMINA</span>
                        <span className="text-gray-500 ml-1">FITNESS</span>
                    </Link>
                    <p className="text-sm text-gray-500 flex flex-col lg:flex-row sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4 items-center">
