                            ...
                            <div className="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
                                ...
                                <form
                                    ...
                                    <div className="text-center">
                                        <Link
                                            to="/Register"
                                            className="inline-block text-sm text-slate-500 dark:text-white align-baseline cursor-pointer hover:text-indigo-400 transition duration-300 ease-in-out"
                                        >
                                            Don't have an account?
                                            <span className="text-indigo-500 font-bold underline ml-2 hover:text-indigo-300 transition duration-200 ease-in-out">
                                                Register Today!
                                            </span>
                                        </Link>
                                    </div>
