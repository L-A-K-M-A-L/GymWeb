                    ...
                    <div className="flex justify-center px-6 py-10">
                        <div className="w-full xl:w-3/4 lg:w-11/12 flex">
                            ...
                            <div className="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
                                <h3 className="py-4 text-5xl text-center text-slate-600 dark:text-white">Welcome Back!</h3>
                                <form
                                    ...
                                    <div className="mb-6 text-center">
                                        <input
                                            className="w-full hover:cursor-pointer px-4 py-2 text-black bg-gradient-to-r from-blue-200 to-gray-400 rounded-full shadow-md hover:from-blue-300 hover:to-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:ring-offset-2 transition-all duration-300 ease-in-out"
                                            type="submit"
                                            value="Sign In"
                                        />
